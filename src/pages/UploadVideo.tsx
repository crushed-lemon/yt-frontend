...
const UploadVideo = () => {
    ...
    useEffect(() => {
        const url = BACKEND_ENDPOINT + "/upload/getPendingUploads/user1";
        axios.get(url)
        .then(response => {
    ...
    return (
        <>
...

            {
                ...
                <div>
                    <label htmlFor="first_name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name your video (you can change this later)</label>
